...
| <a id="ev-13"></a>EV-13 / SC-13 | A future replication design must specify what acknowledged writes survive and how replicas catch up after interruption. | H2, H3, H5, UCA-02, UCA-27 | gap | unverified | [code](../src/lib/queue_proxy_write.cc), [check](../flare_operator/FlareOperator/E2E/Tests/StrictDurability.lean) |
