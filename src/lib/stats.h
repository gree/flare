...
protected:
	...
	AtomicCounter _read_query_without_proxy;
	AtomicCounter _write_query_without_proxy;
...
public:
	...
	inline int increment_read_query_without_proxy()    { this->_read_query_without_proxy.incr();return 0; };
	inline int increment_write_query_without_proxy()   { this->_write_query_without_proxy.incr();return 0; };
	...
	uint64_t get_read_query_without_proxy();
	uint64_t get_write_query_without_proxy();
