...
namespace test_op_node_remove
{
	TEST_OP_CLASS_BEGIN(op_node_remove, NULL)
		EXPOSE(op_node_remove, _node_server_name);
		EXPOSE(op_node_remove, _node_server_port);
	TEST_OP_CLASS_END;
